...
#alias runescape="/usr/lib/jvm/java-13-openjdk-amd64/bin/java -Xmx512m -Dnofork=true -jar ~/Downloads/OSBuddy.jar"
...
alias sortbylength="awk '{ print length, $0 }' | sort -n -s | cut -d\" \" -f2-"
#drilfortune | cowsay
alias ..='cd ..'
